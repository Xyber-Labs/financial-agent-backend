...
var MockERC20MetaData = &bind.MetaData{
	ABI: "[{\"type\":\"function\",\"name\":\"balanceOf\",\"inputs\":[{\"name\":\"user\",\"type\":\"address\",\"internalType\":\"address\"}],\"outputs\":[{\"name\":\"\",\"type\":\"uint256\",\"internalType\":\"uint256\"}],\"stateMutability\":\"view\"},{\"type\":\"function\",\"name\":\"mockSetBalance\",\"inputs\":[{\"name\":\"balance\",\"type\":\"uint256\",\"internalType\":\"uint256\"}],\"outputs\":[],\"stateMutability\":\"nonpayable\"}]",
	Bin: "",
}
...
func (_MockERC20 *MockERC20Caller) BalanceOf(opts *bind.CallOpts, user common.Address) (*big.Int, error) {
	var out []interface{}
	err := _MockERC20.contract.Call(opts, &out, "balanceOf", user)
...
//
// Solidity: function balanceOf(address user) view returns(uint256)
func (_MockERC20 *MockERC20Session) BalanceOf(user common.Address) (*big.Int, error) {
	return _MockERC20.Contract.BalanceOf(&_MockERC20.CallOpts, user)
}

// BalanceOf is a free data retrieval call binding the contract method 0x70a08231.
//
// Solidity: function balanceOf(address user) view returns(uint256)
func (_MockERC20 *MockERC20CallerSession) BalanceOf(user common.Address) (*big.Int, error) {
	return _MockERC20.Contract.BalanceOf(&_MockERC20.CallOpts, user)
}

// MockSetBalance is a paid mutator transaction binding the contract method 0xe1ea6f44.
//
// Solidity: function mockSetBalance(uint256 balance) returns()
func (_MockERC20 *MockERC20Transactor) MockSetBalance(opts *bind.TransactOpts, balance *big.Int) (*types.Transaction, error) {
	return _MockERC20.contract.Transact(opts, "mockSetBalance", balance)
}

// MockSetBalance is a paid mutator transaction binding the contract method 0xe1ea6f44.
//
// Solidity: function mockSetBalance(uint256 balance) returns()
func (_MockERC20 *MockERC20Session) MockSetBalance(balance *big.Int) (*types.Transaction, error) {
	return _MockERC20.Contract.MockSetBalance(&_MockERC20.TransactOpts, balance)
}

// MockSetBalance is a paid mutator transaction binding the contract method 0xe1ea6f44.
//
// Solidity: function mockSetBalance(uint256 balance) returns()
func (_MockERC20 *MockERC20TransactorSession) MockSetBalance(balance *big.Int) (*types.Transaction, error) {
	return _MockERC20.Contract.MockSetBalance(&_MockERC20.TransactOpts, balance)
}
