...
func (_TrustManagementWallet *TrustManagementWalletCaller) WETHADDRESS(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _TrustManagementWallet.contract.Call(opts, &out, "WETH_ADDRESS")
...
//
// Solidity: function WETH_ADDRESS() view returns(address)
func (_TrustManagementWallet *TrustManagementWalletSession) WETHADDRESS() (common.Address, error) {
	return _TrustManagementWallet.Contract.WETHADDRESS(&_TrustManagementWallet.CallOpts)
}

// WETHADDRESS is a free data retrieval call binding the contract method 0x040141e5.
//
// Solidity: function WETH_ADDRESS() view returns(address)
func (_TrustManagementWallet *TrustManagementWalletCallerSession) WETHADDRESS() (common.Address, error) {
	return _TrustManagementWallet.Contract.WETHADDRESS(&_TrustManagementWallet.CallOpts)
}
...
// Withdraw is a paid mutator transaction binding the contract method 0x784fc211.
//
// Solidity: function withdraw(address token, address receiver, uint256[] depositIds, uint256 baseAmount, uint256 amountWithYield) payable returns(uint256 amount, uint256 feeAmount)
func (_TrustManagementWallet *TrustManagementWalletTransactor) Withdraw(opts *bind.TransactOpts, token common.Address, receiver common.Address, depositIds []*big.Int, baseAmount *big.Int, amountWithYield *big.Int) (*types.Transaction, error) {
	return _TrustManagementWallet.contract.Transact(opts, "withdraw", token, receiver, depositIds, baseAmount, amountWithYield)
}

// Withdraw is a paid mutator transaction binding the contract method 0x784fc211.
//
// Solidity: function withdraw(address token, address receiver, uint256[] depositIds, uint256 baseAmount, uint256 amountWithYield) payable returns(uint256 amount, uint256 feeAmount)
func (_TrustManagementWallet *TrustManagementWalletSession) Withdraw(token common.Address, receiver common.Address, depositIds []*big.Int, baseAmount *big.Int, amountWithYield *big.Int) (*types.Transaction, error) {
	return _TrustManagementWallet.Contract.Withdraw(&_TrustManagementWallet.TransactOpts, token, receiver, depositIds, baseAmount, amountWithYield)
}

// Withdraw is a paid mutator transaction binding the contract method 0x784fc211.
//
// Solidity: function withdraw(address token, address receiver, uint256[] depositIds, uint256 baseAmount, uint256 amountWithYield) payable returns(uint256 amount, uint256 feeAmount)
func (_TrustManagementWallet *TrustManagementWalletTransactorSession) Withdraw(token common.Address, receiver common.Address, depositIds []*big.Int, baseAmount *big.Int, amountWithYield *big.Int) (*types.Transaction, error) {
	return _TrustManagementWallet.Contract.Withdraw(&_TrustManagementWallet.TransactOpts, token, receiver, depositIds, baseAmount, amountWithYield)
}
