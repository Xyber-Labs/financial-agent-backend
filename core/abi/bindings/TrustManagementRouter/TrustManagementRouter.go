...
//
// Solidity: function claim(address user, address receiver, address[] tokens, uint256[] amounts, bytes signature, uint256 deadline) returns()
func (_TrustManagementRouter *TrustManagementRouterTransactor) Claim(opts *bind.TransactOpts, user common.Address, receiver common.Address, tokens []common.Address, amounts []*big.Int, signature []byte, deadline *big.Int) (*types.Transaction, error) {
	return _TrustManagementRouter.contract.Transact(opts, "claim", user, receiver, tokens, amounts, signature, deadline)
}

// Claim is a paid mutator transaction binding the contract method 0x099e700b.
//
// Solidity: function claim(address user, address receiver, address[] tokens, uint256[] amounts, bytes signature, uint256 deadline) returns()
func (_TrustManagementRouter *TrustManagementRouterSession) Claim(user common.Address, receiver common.Address, tokens []common.Address, amounts []*big.Int, signature []byte, deadline *big.Int) (*types.Transaction, error) {
	return _TrustManagementRouter.Contract.Claim(&_TrustManagementRouter.TransactOpts, user, receiver, tokens, amounts, signature, deadline)
}

// Claim is a paid mutator transaction binding the contract method 0x099e700b.
//
// Solidity: function claim(address user, address receiver, address[] tokens, uint256[] amounts, bytes signature, uint256 deadline) returns()
func (_TrustManagementRouter *TrustManagementRouterTransactorSession) Claim(user common.Address, receiver common.Address, tokens []common.Address, amounts []*big.Int, signature []byte, deadline *big.Int) (*types.Transaction, error) {
	return _TrustManagementRouter.Contract.Claim(&_TrustManagementRouter.TransactOpts, user, receiver, tokens, amounts, signature, deadline)
}
...
// Withdraw is a paid mutator transaction binding the contract method 0x9cb9a269.
//
// Solidity: function withdraw(address user, address token, address receiver, uint256[] depositIds, uint256 amountsWithYield, bytes signature, uint256 deadline) returns()
func (_TrustManagementRouter *TrustManagementRouterTransactor) Withdraw(opts *bind.TransactOpts, user common.Address, token common.Address, receiver common.Address, depositIds []*big.Int, amountsWithYield *big.Int, signature []byte, deadline *big.Int) (*types.Transaction, error) {
	return _TrustManagementRouter.contract.Transact(opts, "withdraw", user, token, receiver, depositIds, amountsWithYield, signature, deadline)
}

// Withdraw is a paid mutator transaction binding the contract method 0x9cb9a269.
//
// Solidity: function withdraw(address user, address token, address receiver, uint256[] depositIds, uint256 amountsWithYield, bytes signature, uint256 deadline) returns()
func (_TrustManagementRouter *TrustManagementRouterSession) Withdraw(user common.Address, token common.Address, receiver common.Address, depositIds []*big.Int, amountsWithYield *big.Int, signature []byte, deadline *big.Int) (*types.Transaction, error) {
	return _TrustManagementRouter.Contract.Withdraw(&_TrustManagementRouter.TransactOpts, user, token, receiver, depositIds, amountsWithYield, signature, deadline)
}

// Withdraw is a paid mutator transaction binding the contract method 0x9cb9a269.
//
// Solidity: function withdraw(address user, address token, address receiver, uint256[] depositIds, uint256 amountsWithYield, bytes signature, uint256 deadline) returns()
func (_TrustManagementRouter *TrustManagementRouterTransactorSession) Withdraw(user common.Address, token common.Address, receiver common.Address, depositIds []*big.Int, amountsWithYield *big.Int, signature []byte, deadline *big.Int) (*types.Transaction, error) {
	return _TrustManagementRouter.Contract.Withdraw(&_TrustManagementRouter.TransactOpts, user, token, receiver, depositIds, amountsWithYield, signature, deadline)
}
